    ...
    return (
      <FinalForm
        ...
        render={formRenderProps => {
          ...
          const chooseMainImageText = (
            <span className={css.chooseImageText}>
              <span className={css.chooseImage}>
                <FormattedMessage id="EditEquipmentListingPhotosForm.chooseMainImage" />
              </span>
          ...
          const chooseOtherImageText = (
            <span className={css.chooseImageText}>
              <span className={css.chooseImage}>
                <FormattedMessage id="EditEquipmentListingPhotosForm.chooseOtherImage" />
              </span>
              <span className={css.imageTypes}>
                <FormattedMessage id="EditListingPhotosForm.imageTypes" />
              </span>
              ...
              >
                {images.length <2 && (
                  <Field
                    ...
                    form={null}
                    label={images.length>0 ? chooseOtherImageText : chooseMainImageText}
                    type="file"
