...
import css from './BookingTimePanel.module.css';
...
const BookingTimePanel = props => {
  ...
  const canHourlyBooking = ()=>{
    switch (listing.attributes.publicData.listingType) {
