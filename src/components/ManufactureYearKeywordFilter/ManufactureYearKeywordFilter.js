...
class ManufactureYearKeywordFilter extends Component {
  ...
  render() {
    ...
    const labelForPopup = hasInitialValues
      ? intl.formatMessage(
          { id: 'ManufactureYearKeywordFilter.labelSelected' },
    ...
    const labelForPlain = hasInitialValues
      ? intl.formatMessage(
          { id: 'ManufactureYearKeywordFilterPlainForm.labelSelected' },
          { labelText: initialValues[urlParam] }
        )
      : label;

    const filterText = intl.formatMessage({ id: 'ManufactureYearKeywordFilter.filterText' });
...
ManufactureYearKeywordFilter.defaultProps = {
  rootClassName: null,
  className: null,
  initialValues: null,
...
ManufactureYearKeywordFilter.propTypes = {
...
export default injectIntl(ManufactureYearKeywordFilter);
